...
plot 'analyze.txt' using 1:($1>2013 ? 1/0 : $2) with boxes lt 3 title 'yearly totals',\
     '' using 1:($2+25):2 with labels title '',\
     '' using 1:($1<2014 ? 1/0 : $2) with boxes lt 8 title 'as of '.date
