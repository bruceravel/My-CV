...
%\fax{1-631-344-5419}
\email{bravel.ravel@nist.gov}
%\homepage{http://bruceravel.github.io/home/}
\homepage{http://github.com/bruceravel}
\extrainfo{\href{https://github.com/NSLS-II-BMM}{https://github.com/NSLS-II-BMM}}
%\extrainfo{\href{https://speakerdeck.com/bruceravel}{https://speakerdeck.com/bruceravel}}
\photo[64pt]{BR_nsls2.jpg}  % '64pt' is the height the picture must
...
\pagebreak
\section{Awards}
\cvline{2017}{Department of Commerce Bronze Medal:
  For the exemplary application of a unique data analysis and
  visualization system used globally by synchrotron X-ray absorption
  spectroscopists.}
\cvline{2020}{NSLS-II UEC Community Service Award}
\cvline{2022}{International X-ray Absorption Society Outstanding
  Achievement Award (Edward Stern Prize)}
...
\cvline{Synchronous multi-modal experiments}%
...
%   scattering paths.}
%
\cvline{Beamline user experience}%
...
\cvlistitem{NSLS-II, Brookhaven National Laboratory, March 11-13, 2025}%
\cvlistitem{NSLS-II, Brookhaven National Laboratory, March 19-21, 2024}%
\cvlistitem{NSLS-II, Brookhaven National Laboratory, October 10-12, 2023}%
...
\cvline{NSLS-II}{
  \begin{itemize}
  \item Beamline Proposal Team, Beamline Advisory Team, Final Design
    Review Panel for the ISS Beamline, 2011-2013
  \item Beamline Advisory Team for the SRX beamline, 2013-2014
  \item Spectroscopy Proposal Review Panel, 2014--2017
  \item Remote Experiment Task Force, 2020-2021
  \item Osiris Software Advisory Team, chair, 2021
  \item DSSI Advisory Council, 2022-2025
  \item Bluesky Power User Pilot, 2024
  \end{itemize}
}%
\cvline{NSLS}{
  \begin{itemize}
  \item Chair, Proposal Oversight Panel, 2012 -- 2014
  \item Chair, Users' Executive Committee 2010, 2013
  \end{itemize}}%
\cvline{APS}{
  \begin{itemize}
  \item Spectroscopy beamline review, March 7--8, 2016
  \end{itemize}
}
...
\cvline{IUCr}{
  \begin{itemize}
  \item Member, Commission on XAFS, 2014 -- 2023
  \end{itemize}
}
\cvline{CLS}{
  \begin{itemize}
  \item Chair of the Proposal Review Committee, 2012 -- 2015
  \item Spectroscopy Beamline Review Panel, October 2--4, 2024
  \end{itemize}
}%
\cvline{Synchrotron proposal review}{
  \begin{itemize}
  \item Current reviewer in spectroscopy at SSRL, CHESS,
    Elettra, and SESAME
  \item Past reviewer in spectroscopy at CLS, Spring-8
  \item Chair, APS Spectroscopy Proposal Review Panel, 2008 -- 2012
  \end{itemize}
}
